        ...
        <div class="login-main">
          ...
          >
            ...
            <div class="other_login">
              ...
              <div>
                <span>
                  <a class="linka" target="_blank" href="https://github.com/login/oauth/authorize?client_id=fe5f5ed373582840c4bf&scope=user:email">
                    <img  src="@/assets/icons/logo-github.svg" loading="lazy" alt="GitHub" class="site" />
                    <!-- <img src="https://developers.google.com/static/site-assets/logo-github.svg" loading="lazy" alt="GitHub" class="site" /> -->
                  </a>
                </span>
          ...
          <!-- <el-form-item style="width: 100%; text-align: center;" class="flex">
    ...
    if(code){
      ...
      if (type == "github"){
        this.$store
            ...
            .catch(() => {
              _this.$message("授权登录失败，请使用账户密码登录")
            })
      }else{
        _this.$message("不支持该登录方式")
      }
